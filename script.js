...
const NIGHTS = [
  ...
  },
 {
  ...
  },
  {
    ...
    venue: "Sendai, Miyagi",
    matches: [
      { block: "A", a: "Hirooki Goto",       b: "Jake Lee",       winner: "Jake Lee",           method: "FBS",                                    time: "09:55" },
      { block: "A", a: "Great-O-Khan",       b: "Ryohei Oiwa",    winner: "Ryohei Oiwa",        method: "Roy Clutch",                             time: "13:27" },
      { block: "A", a: "Konosuke Takeshita", b: "Yuto-Ice",       winner: "Konosuke Takeshita", method: "Referee Stoppage (Chickenwing sleeper)", time: "12:04" },
      { block: "A", a: "Yota Tsuji",         b: "SANADA",         winner: "SANADA",             method: "Deadfall",                               time: "15:23" },
      { block: "A", a: "Boltin Oleg",        b: "Shingo Takagi",  winner: "Boltin Oleg",        method: "Kamikaze",                               time: "19:10" },
    ]
  },
  {
    id: "night5",
  ...
  },
  {
    ...
    matches: [
      { block: "A", a: "Boltin Oleg",        b: "SANADA",             winner: "Boltin Oleg",         method: "Kamikaza",           time: "1:30" },
      { block: "A", a: "Yuto-Ice",           b: "Jake Lee",           winner: "Yuto-Ice",            method: "Cruella",            time: "10:37" },
      { block: "A", a: "Shingo Takagi",      b: "Great-O-Khan",       winner: "Shingo Takagi",       method: "Last of the Dragon", time: "9:56" },
      { block: "A", a: "Yota Tsuji",         b: "Ryohei Oiwa",        winner: "Yota Tsuji",          method: "Fire Blaster",       time: "19:37" },
      { block: "A", a: "Hirooki Goto",       b: "Konosuke Takeshita", winner: "Konosuke Takeshita",  method: "Raging Fire",        time: "18:04" },
    ]
  },
  {
    id: "night11",
  ...
  },
  {
    ...
    venue: "Japan Tour",
    matches: [
      { block: "A", a: "Yuto-Ice",           b: "SANADA",         winner: "SANADA",         method: "KO",                 time:"8:10" },
      { block: "A", a: "Jake Lee",           b: "Great-O-Khan",   winner: "Jake Lee",       method: "DQ",                 time: "1:47" },
      { block: "A", a: "Hirooki Goto",       b: "Ryohei Oiwa",    winner: "Ryohei Oiwa",    method: "Big Lock",           time:"8:51" },
      { block: "A", a: "Konosuke Takeshita", b: "Shingo Takagi",  winner: "Shingo Takagi",  method: "Last of the Dragon", time:"19:44" },
      { block: "A", a: "Yota Tsuji",         b: "Boltin Oleg",    winner: "Boltin Oleg",    method: "Last Kamikaze",      time:"24:35"},
    ]
  },
  {
    id: "night13",
